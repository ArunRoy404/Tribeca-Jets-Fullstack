...
export default function TaskDetailSheet() {
  ...
  return (
    <Sheet open={!!task} onOpenChange={(open) => !open && closeTaskDetail()}>
      <SheetContent className="data-[side=right]:w-full sm:data-[side=right]:max-w-150 gap-4 p-6 overflow-y-auto">
        {task && (
          <>
            <div className="border-b border-secondary flex flex-col gap-4 pb-4 w-full">
              <p className="font-montserrat font-bold text-[20px] text-black-text pr-8">Task Details</p>
