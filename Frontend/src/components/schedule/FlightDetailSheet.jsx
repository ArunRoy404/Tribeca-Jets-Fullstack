...
export default function FlightDetailSheet() {
  ...
  return (
    <Sheet open={!!event} onOpenChange={(open) => !open && closeEventDetail()}>
      <SheetContent className="data-[side=right]:w-full sm:data-[side=right]:max-w-140 gap-4 p-6 overflow-y-auto">
        {event && (
          <>
